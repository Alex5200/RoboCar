...
constexpr int GEARBOX_PIN_A = 8;     // Управление режимом A
...
// Аналоговые входы
constexpr int potStop = A0;      // Потенциометр коробки передач
constexpr int angleSensor = A1;  // Потенциометр руля для получения текущего угла
...
constexpr float Ki = 0.01;  // Интегральный коэффициент
